...
use crate::{fix_messages::{Body, FixHeader, FixTrailer}, requests::Request, responses::Response, example_plugin::ExamplePlugin};
...
impl Solver {
    pub fn new(fix_server_weak: Weak<RwLock<Server<Response, ExamplePlugin<Request, Response>>>>, event_rx: Receiver<SolverEvents>) -> Self {
        Solver {
            fix_server_weak,
            event_rx,
            handle: None,

use axum::{extract::Request, http::request, response};
use eyre::{Report, Result};
use crate::{messages::{ServerRequest, ServerResponse, SessionId}, plugins::{seq_num_plugin::{SeqNumPlugin, SeqNumPluginAux}, serde_plugin::{self, SerdePlugin}}};

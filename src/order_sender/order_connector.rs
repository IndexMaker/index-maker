...
use crate::core::bits::{Amount, Order, OrderId, Symbol};
use eyre::Result;
...
pub mod test_util {
    ...
    use crate::core::{
        bits::{Amount, Order, OrderId, Symbol},
    ...
    impl MockOrderConnector {
        ...
        pub fn notify_cancel(&self, order_id: OrderId, symbol: Symbol, quantity: Amount) {
            self.observer

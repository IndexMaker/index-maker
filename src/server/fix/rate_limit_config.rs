...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.fix_message_weights.get("CancelQuoteRequest"), Some(&3));
    ...
    fn test_config_comparison() {
        ...
        assert!(production_config.base.session_limits[0].limit < development_config.base.session_limits[0].limit);
        assert!(production_config.base.user_limits[0].limit < development_config.base.user_limits[0].limit);
        assert!(production_config.base.global_limits[0].limit < development_config.base.global_limits[0].limit);
        
        // All configs should have the same FIX message weights
        assert_eq!(default_config.fix_message_weights, production_config.fix_message_weights);
        assert_eq!(default_config.fix_message_weights, development_config.fix_message_weights);
    }

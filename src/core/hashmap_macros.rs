    ...
    ($actual:expr, $expected:expr, $tolerance:expr) => {
        {
            ...
            assert_eq!(actual.len(), expected.len(), "HashMaps have different lengths");
...
mod tests {
    ...
    fn test_assert_hashmap_amounts_eq_passes() -> Result<()> {
        let actual: HashMap<Symbol, Amount> = [
            ...
            ("ETH".into(), "1.1021739130434782608695652174".try_into()?) ].into();
        
        let expected: HashMap<Symbol, Amount> = [
            ("BTC".into(), "0.0417490118577075078814229249".try_into()?),
            ("ETH".into(), "1.1021739130434782638695652174".try_into()?) ].into();
    ...
    fn test_assert_hashmap_amounts_eq_wrong_value() {
        let actual: HashMap<Symbol, Amount> = [
            ("BTC".into(), "0.0417490118577075098814229249".try_into().unwrap()),
            ("ETH".into(), "1.1021739130434782608695652174".try_into().unwrap()) ].into();
        
        let expected: HashMap<Symbol, Amount> = [
            ("BTC".into(), "0.9417490118577075078814229249".try_into().unwrap()),
            ("ETH".into(), "1.1721739130434782638695652174".try_into().unwrap()) ].into();
    ...
    fn test_assert_hashmap_amounts_eq_wrong_key() {
        ...
        let expected: HashMap<Symbol, Amount> = [
            ("BTC".into(), "0.0417490118577075098814229249".try_into().unwrap()),
            ("SOL".into(), "1.1021739130434782608695652174".try_into().unwrap()) ].into();
